...
public class MainActivity extends AppCompatActivity {
    ...
    // Solid HDS2 9048 IR Frequency
    private static final int IR_FREQUENCY = 38000;

    // ---- IR PATTERNS (NEC format converted to pulse/space arrays) ----
    // These are common Solid STB codes - may need tuning
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!getPackageManager().hasSystemFeature(PackageManager.FEATURE_CONSUMER_IR)) {
            Toast.makeText(this, "⚠️ This device does NOT have IR Blaster!", Toast.LENGTH_LONG).show();
        } else {
